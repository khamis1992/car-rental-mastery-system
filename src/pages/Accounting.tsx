...
import { ChartOfAccountsCleanup } from '@/components/Accounting/ChartOfAccountsCleanup';
    ...
    <div className="p-6 space-y-6">
      ...
      <Tabs defaultValue="transactions" className="space-y-4">
        <TabsList className="grid w-full grid-cols-7">
          <TabsTrigger value="cleanup">تنظيف الدليل</TabsTrigger>
