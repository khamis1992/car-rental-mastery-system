      ...
      for (let i = 0; i < vehicles.length; i++) {
        ...
        try {
          ...
          await vehicleService.createVehicle({
            ...
            min_daily_rate: vehicle.min_daily_rate,
            max_daily_rate: vehicle.max_daily_rate,
            mileage_limit: vehicle.mileage_limit,
            excess_mileage_cost: vehicle.excess_mileage_cost,
            ...
            depreciation_method: vehicle.depreciation_method,
