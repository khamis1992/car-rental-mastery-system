  ...
  const onSubmit = async (data: ContractFormData) => {
    ...
    try {
      ...
      const contractData = {
        ...
        terms_and_conditions: generateTermsAndConditions(),
        notes: data.notes,
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="bg-card border rounded-lg p-6 space-y-4">
              ...
              <div className="space-y-6">
                {/* Default Terms and Conditions Display */}
                <div className="space-y-4">
                  <div className="flex items-center gap-2">
                    <h4 className="text-sm font-medium">الشروط والأحكام العامة</h4>
                  </div>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-sm font-medium">شروط خاصة إضافية</FormLabel>
                      <FormControl>
                        <Textarea 
                          placeholder="أدخل أي شروط خاصة إضافية للعقد..."
