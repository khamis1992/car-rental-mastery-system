...
import { ArrowLeft, Car, Shield, Zap, Building } from "lucide-react";
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                ...
                <Link to="/auth">
                  <Button size="lg" variant="outline" className="text-lg px-8 py-4 border-white/30 text-white hover:bg-white/10">
                    {getContentValue('hero', 'cta_text') || 'تسجيل الدخول'}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-gray-50 p-3 rounded-lg text-center">
                        <div className="text-lg font-bold text-gray-800">١٨٥</div>
                        <div className="text-xs text-gray-600">مركبة نشطة</div>
                      </div>
                      <div className="bg-gray-50 p-3 rounded-lg text-center">
                        <div className="text-lg font-bold text-gray-800">٩٢٪</div>
                        <div className="text-xs text-gray-600">معدل التشغيل</div>
                      </div>
                    </div>
                  </div>
                </div>
