-- إصلاح الخطأ في create_payment_accounting_entry
...
BEGIN
    ...
    IF payment_method = 'bank_transfer' THEN
        ...
        LIMIT 1;
    ELSE
        SELECT id INTO cash_account FROM public.chart_of_accounts WHERE account_code = '111001';
    END IF;
    ...
    INSERT INTO public.journal_entry_lines (
        ...
        new_journal_entry_id, cash_account, 'تحصيل نقدي - ' || invoice_number, payment_amount, 0, 1
    );
    ...
    INSERT INTO public.journal_entry_lines (
        ...
        new_journal_entry_id, revenue_account, 'إيراد تأجير - ' || invoice_number, 0, payment_amount, 2
    );
