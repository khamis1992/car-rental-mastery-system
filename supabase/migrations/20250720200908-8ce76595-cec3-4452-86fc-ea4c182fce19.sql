-- إصلاح مشكلة تطابق نوع البيانات في دالة get_general_ledger_entries_enhanced
-- تغيير reference_id من uuid إلى text لمطابقة نوع البيانات في جدول journal_entries
