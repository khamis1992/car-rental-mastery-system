-- المرحلة الثانية المصححة: إصلاح مشاكل RLS للجداول التي تحتوي على tenant_id

-- 1. إضافة سياسات RLS للجداول المهمة
