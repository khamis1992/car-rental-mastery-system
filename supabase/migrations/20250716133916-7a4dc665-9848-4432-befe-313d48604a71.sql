-- استكمال دليل الحسابات لمؤسسة البشائر
DO $$
DECLARE
...
BEGIN
    ...
    (bashaer_tenant_id, '32', 'الاحتياطيات', 'Reserves', 'equity', 'retained_earnings', parent_id, 2, false, true, 0, 0, true),
    (bashaer_tenant_id, '33', 'الأرباح المحتجزة', 'Retained Earnings', 'equity', 'retained_earnings', parent_id, 2, false, true, 0, 0, true)
    ON CONFLICT (tenant_id, account_code) DO NOTHING;
    ...
    (bashaer_tenant_id, '42', 'إيرادات أخرى', 'Other Revenue', 'revenue', 'other_revenue', parent_id, 2, false, true, 0, 0, true)
    ON CONFLICT (tenant_id, account_code) DO NOTHING;
    ...
    (bashaer_tenant_id, '52', 'مصروفات إدارية', 'Administrative Expenses', 'expense', 'administrative_expense', parent_id, 2, false, true, 0, 0, true),
    (bashaer_tenant_id, '53', 'مصروفات تمويلية', 'Financial Expenses', 'expense', 'financial_expense', parent_id, 2, false, true, 0, 0, true)
    ON CONFLICT (tenant_id, account_code) DO NOTHING;
    ...
    INSERT INTO public.chart_of_accounts (tenant_id, account_code, account_name, account_name_en, account_type, account_category, parent_account_id, level, allow_posting, is_active, opening_balance, current_balance, ksaap_compliant)
    VALUES 
    (bashaer_tenant_id, '5201', 'رواتب وأجور', 'Salaries and Wages', 'expense', 'administrative_expense', parent_id, 3, true, true, 0, 0, true),
    (bashaer_tenant_id, '5202', 'إيجار المكاتب', 'Office Rent', 'expense', 'administrative_expense', parent_id, 3, true, true, 0, 0, true),
    (bashaer_tenant_id, '5203', 'مصروفات الكهرباء والماء', 'Utilities Expenses', 'expense', 'administrative_expense', parent_id, 3, true, true, 0, 0, true),
    (bashaer_tenant_id, '5204', 'مصروفات الاتصالات', 'Communication Expenses', 'expense', 'administrative_expense', parent_id, 3, true, true, 0, 0, true),
    (bashaer_tenant_id, '5205', 'مصروفات القرطاسية', 'Stationery Expenses', 'expense', 'administrative_expense', parent_id, 3, true, true, 0, 0, true)
    ON CONFLICT (tenant_id, account_code) DO NOTHING;
