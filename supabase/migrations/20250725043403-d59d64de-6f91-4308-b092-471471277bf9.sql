-- إصلاح دالة get_current_tenant_id للتعامل مع مرجع user_id الغامض
...
BEGIN
    ...
    -- البحث عن المؤسسة في tenant_users أولاً مع تحديد أسماء الأعمدة بوضوح
    ...
    -- إذا لم توجد في tenant_users، البحث في tenant_user_roles مع تحديد أسماء الأعمدة بوضوح
