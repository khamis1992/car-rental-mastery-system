-- Fix hard_delete_tenant function with correct deletion order and better error handling
...
BEGIN
    ...
    -- Contract extension before contracts
    ...
    -- Contract evaluation before contracts
    ...
    -- Contract incidents before contracts
    ...
    -- Contract accounting entries before contracts
