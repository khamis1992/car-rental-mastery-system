-- Fix the data type issue in log_transaction function - ensure source_id is handled as UUID
CREATE OR REPLACE FUNCTION public.log_transaction(
  p_transaction_type text,
  p_source_table text,
  p_source_id uuid,  -- Changed from text to uuid to match table schema
...
BEGIN
  ...
  INSERT INTO transaction_log (
    ...
    p_transaction_type,
    p_source_table,
    p_source_id,  -- Now properly typed as UUID
    p_department_id,
