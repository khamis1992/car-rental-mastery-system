-- النظام المتكامل الشامل - الإصدار الرابع
-- حل مشكلة التضارب في أسماء المتغيرات
...
-- دالة مساعدة للتحقق من وجود العمود (بأسماء متغيرات واضحة)
...
-- دالة مساعدة للتحقق من وجود الجدول (بأسماء متغيرات واضحة)
...
BEGIN
    ...
    IF table_exists('user_roles') THEN
        RAISE NOTICE 'الجدول user_roles موجود، جاري التحقق من الأعمدة...';
    ...
    ELSE
        ...
        RAISE NOTICE 'تم إنشاء الجدول user_roles';
    END IF;
END $$;
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        -- تأكد من أن العمود role_id موجود
...
('20250101_v4', 'النظام المتكامل الشامل - الإصدار الرابع - حل مشكلة التضارب في أسماء المتغيرات')
...
DO $$ 
BEGIN
    RAISE NOTICE 'تم إنشاء النظام المتكامل الشامل بنجاح! الإصدار الرابع - حل مشكلة التضارب في أسماء المتغيرات - تاريخ: %', NOW();
END $$; 