-- Performance Optimization: Creating optimized indexes (Fixed version)
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_vehicles_contract_tenant 
...
-- 7. Performance statistics function
