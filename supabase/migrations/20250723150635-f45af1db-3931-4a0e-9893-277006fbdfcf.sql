-- إصلاح عزل المؤسسات مع التعامل مع الحسابات الموجودة

-- إنشاء دالة آمنة للحصول على المؤسسة الافتراضية
...
BEGIN
    ...
    -- إذا لم توجد، إنشاء مؤسسة افتراضية بسيطة
    IF default_tenant_id IS NULL THEN
        ...
        -- تحديث دليل الحسابات الموجود ليربط بهذه المؤسسة
...
-- تعطيل trigger المؤسسات مؤقتاً لتجنب التضارب
