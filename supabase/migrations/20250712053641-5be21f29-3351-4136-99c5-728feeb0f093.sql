-- Fix the create_tenant_with_admin function to use correct column name subscription_plan
...
BEGIN
  ...
  -- Create the tenant using the correct column name subscription_plan
