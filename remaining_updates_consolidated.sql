-- ========================================
-- التحديثات المتبقية الضرورية - ملف موحد
-- التاريخ: 2025-01-01
-- الغرض: إكمال التحديثات المطلوبة بعد database_updates_fixed.sql
-- ========================================

-- ==========================================
-- جداول إدارة المستأجرين المتقدمة
-- ==========================================

-- جدول المستأجرين الرئيسي
...
INSERT INTO tenants (name, domain, status, tier) VALUES 
    ('نظام إدارة السيارات الرئيسي', 'main.car-rental.com', 'active', 'enterprise')
